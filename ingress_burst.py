...
print "========set ingress_policing_burst: 0========"
get_schema = {"method":"transact", \
              "params":["Open_vSwitch",{"row":{"ingress_policing_burst":0},\
              ...
              {"comment":"ovs-vsctl: ovs-vsctl -vjsonrpc set interface br100 ingress_policing_burst=10000","op":"comment"}], 'id':1}
s.send(json.dumps(get_schema))
